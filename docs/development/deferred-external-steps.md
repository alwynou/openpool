...
- [ ] 经项目所有者单独授权后，把本地完成的认证限流/readiness preflight 与 Web i18n 发布到
  staging；发布后核对 health 200、bootstrap 已删除、真实 429/恢复窗口和现有登录/session。该步骤
  不需要 D1 migration，当前实现与测试完成不构成远端部署授权。
