...
- Logical Bucket/Shard：`LOGICAL_BUCKET_CREATED`、`LOGICAL_BUCKET_PUBLIC_ACCESS_UPDATED`、
  `STORAGE_SHARD_CREATED`、`STORAGE_SHARD_STATUS_CHANGED`；
- Object：`OBJECT_UPLOAD_RESERVED`、`OBJECT_UPLOAD_COMPLETED`、`OBJECT_UPLOAD_EXPIRED`、
  `OBJECT_UPLOAD_ABORTED`、`OBJECT_DOWNLOAD_SIGNED`、`OBJECT_PUBLIC_ACCESS_UPDATED`、
  `OBJECT_DELETE_STARTED`、`OBJECT_DELETED`；
